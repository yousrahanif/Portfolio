...
//     {/* Designation */}
//     <h1 className="text-4xl font-extrabold mt-6 tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500">
//   Yousra Hanif
// </h1>
...
//       <p>Email: <a href="mailto:yousrahanif26@gmail.com" className="text-teal-500 hover:underline">yousrahanif26@gmail.com</a></p>
//       <p>Phone: <span className="text-teal-500">+1 (347) 748-3329</span></p>
//     </div>
...
const Header = () => (
  <header className="text-center p-8 bg-gradient-to-r from-blue-50 to-white rounded-2xl shadow-lg">
    ...
    {/* Contact Info with Background Block */}
    <div className="mt-6 bg-gradient-to-r from-blue-50 to-white rounded-lg shadow-md p-6">
      <div className="mt-4 text-lg text-gray-700">
        <div className="flex items-center justify-center gap-2">
          <FaEnvelope className="text-blue-500" />
          <p>Email: <a href="mailto:yousrahanif26@gmail.com" className="text-blue-500 hover:underline">yousrahanif26@gmail.com</a></p>
        </div>
        <div className="flex items-center justify-center gap-2 mt-2">
          <FaPhoneAlt className="text-blue-500" />
          <p>Phone: <span className="text-blue-500">+1 (347) 748-3329</span></p>
        </div>
      </div>
    </div>
    ...
    <div className="flex justify-center mt-6 gap-8">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-700 text-3xl hover:text-blue-500 hover:scale-110 transition-transform"
        aria-label="LinkedIn Profile"
      >
        <FaLinkedin />
      </a>
